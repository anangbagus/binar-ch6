...
describe('user_biodata todos list', () => {
    ...
    test(`POST ${path} --> Success create biodata`, async () => {
    ...
    test(`POST ${path} --> userGameUserId and name needed`, async () => {
        ...
        expect(body).toEqual(
            expect.objectContaining({
                message: "notNull Violation: user_game_biodata.userGameUserId cannot be null",
                message: "notNull Violation: user_game_biodata.name cannot be null"
            })
        )
    })
    ...
    test(`POST ${path} --> user_game data needed for foreign key`, async () => {
        ...
        expect(body).toEqual(
            expect.objectContaining({
                message: "insert or update on table \"user_game_biodata\" violates foreign key constraint \"user_game_biodata_userGameUserId_fkey\""
            })
        )
    })
